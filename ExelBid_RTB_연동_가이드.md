...
:---------|:--------|:-------------|:-----------------------------------------------------------------------------------
 ...
 geo      | object  |              | 위치 정보
 etc      | object array  |              | uid 포함. 3.2.12.1 Object:Ext 참조
...
:---------|:--------|:-------------|:-----------------------------------------------------------------------------------
 source   | string  |              | 도메인정보
 uids     | object array |              | uid정보. 3.2.12.2 Object: UID 참조                                                                     
 etc      | object  |              |                                            
 ...
 Name     | Type    | 필수, 기본값 | Description                                                                        
:---------|:--------|:-------------|:-----------------------------------------------------------------------------------
 id       | string  |              | 사용자 아이디 (이메일, 전화번호 등..)
 atype    | integer |              | 아이디 출처 3.2.12.3 List:Agent Types 참조                                                                     
 etc      | object  |              |        

 ##### 3.2.12.3 List: Agent Types
